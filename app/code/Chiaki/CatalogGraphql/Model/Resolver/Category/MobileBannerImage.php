...
/**
 * Resolve category mobile image to a fully qualified URL
 */
class MobileBannerImage implements ResolverInterface
{
    /** @var DirectoryList  */
    ...
    public function resolve(
        ...
        $imagePath = $category->getData('mobile_banner_image');
        if (empty($imagePath)) {
            return null;
        }
