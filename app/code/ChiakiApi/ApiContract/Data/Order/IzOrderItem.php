...
namespace ChiakiApi\ApiContract\Data\Order;


use ChiakiApi\ApiContract\Data\AbstractApiDataObject;

class IzOrderItem extends AbstractApiDataObject
{
    ...
    public function getItemPosCode()
    {
        return $this->getData('item_pos_code');
    }

    public function getRkCategoryCode()
    {
        return $this->getData('rk_category_code');
    }

    public function getRkModifier()
    {
        return $this->getData('rk_modifier');
    }

    public function getRkTopping()
    {
        return $this->getData('rk_topping');
    }
}
